...
<aside id="left">
	...
	<nav id="menu">
		<ul class="slimmenu">
			...
			<li><a href="?action=mailing" title="{'Mailing'|lang}" class="link"><span class="icon icon_kalendarz"></span>{'Mailing'|lang}</a></li>
			<li><span class="link"><span class="icon icon_hanger"></span>{'Additional'|lang}</span>
				<ul><li><a href="?action=offers_categories" title="{'Categories'|lang}">{'Categories'|lang}</a></li>
			...
			<li><a href="?action=settings" title="{'Settings'|lang}" class="link"><span class="icon icon_settings"></span>{'Settings'|lang}</a>
				<ul>
					<li><a href="?action=settings_black_list" title="{'Black list'|lang}">{'Black list'|lang}</a></li>
