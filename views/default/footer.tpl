			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<ul class="list-unstyled row">
						...
						<li><a class="col-xs-6" href="{$links.offers}" title="{'Search the best accommodation'|lang}">{'Accommodation'|lang}</a></li>
						...
						<li><a class="col-xs-6" href="{$links.contact}" title="{'Contact us'|lang}">{'Contact'|lang}</a></li>
