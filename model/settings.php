...
if($user->logged_in){
	...
	if(isset($_POST['action'])){
		if($_POST['action']=='change_password' and isset($_POST['old_password']) and $_POST['old_password']!='' and isset($_POST['new_password']) and $_POST['new_password']!='' and isset($_POST['repeat_new_password']) and $_POST['repeat_new_password']!=''){
